import argparse
from llms.openai_backend_new import OpenAILLM  # Update this import to point to the correct path
from pipeline.summarizer_new import summarize_podcast_full
from utils.io_utils import load_text, save_text
from utils.evaluation import evaluate_summary


def main():
    parser = argparse.ArgumentParser(description="Summarize a Markdown podcast transcript using OpenAI LLM")
    ...
    # Generate the summary using OpenAI LLM
    llm = OpenAILLM()
